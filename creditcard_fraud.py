...
# Display dataframe shape and description
if st.sidebar.checkbox('Show what the dataframe looks like'):
    st.write(df.head(100))
    st.write('Shape of the dataframe: ', df.shape)
    st.write('Data description: \n', df.describe()),
# Display valid and fraud transactions
fraud = df[df.Class == 1]
valid = df[df.Class == 0]
...
# Obtain X (features) and y (labels)
...
# Performance metrics and imbalanced rectifiers
